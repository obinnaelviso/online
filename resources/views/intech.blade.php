...
@section('content')
            ...
            <div id="homeSlider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="assets/img/slide55.jpg" alt="slide1">
					...
					<div class="item">
                        <img src="assets/img/pro4.jpg" alt="slide2">
                        <div class="carousel-caption">
							<h4><i class="fa fa-star-o"></i>WE EMPOWER YOU TO CREATE<i class="fa fa-star-o"></i></h4>
                           <h2>EDUCATE <span><i class="fa fa-graduation-cap"></i>ILLUMINATE</span> <span> <i class="fa fa-graduation-cap"></i> </span> CREATE</h2>
                            <p>We here at <strong>UNIVERSITI MALAYA</strong> provides best education <br />  </p>
			...
			<div class="container">
				<div class="col-sm-4 col-md-3">
					<div class="academic-nav-box">
						...
						<div class="academic-nav-inner-box">
							...
							<a href="#"><i class="fa fa-users"></i>InTecH</a>
				...
				<div class="col-sm-8 col-md-9">
					<div class="academic-content-box">
						...
						<p>Instructional Technology Hub (InTecH) is in progress of becoming the hub for professional development. The inTecH allows access to professional developments such as future services like online courses of professional building for working adults, seminars, activities organised, as well as gallery, and booking of space</p>
		...
		<div class="container">
				<h2><i class="fa fa-picture-o"></i>INTECH GALLERY</h2>
			</div>
		</div>
<!-- START: GALLERY -->
				...
				<div class="image-set">
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/pro.jpg" alt="Cruise">
							<div class="img-caption">
								<div class="link">
									<a title="Fine Arts" href="assets/img/pro.jpg">
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/pro1.jpg" alt="Cruise">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/pro1.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intech7.jpg" alt="Cruise">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/intech7.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intech3.jpg" alt="Intech">
							<div class="img-caption">
								<div class="link">
									<a title="Fine Arts" href="assets/img/intech3.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intech6.jpg" alt="Intech">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/intech5.mp4">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intech1.jpg" alt="Intech">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/intech1.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
...
<form action="{{ route('intech') }}" method="post">
{{ csrf_field() }}
			...
			<div class="col-xs-12">
				<h3><i class="fa fa-edit"></i>BOOK OUR SPACE TODAY.</h3>
					...
					@if(session()->has('success'))
						<div class="alert alert-warning">{{ session()->get('success') }}
					@endif
			</div>
			<div class="col-xs-6">
