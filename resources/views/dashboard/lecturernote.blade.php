				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-users"></i>LECTURER'S FILES</h5>
					...
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-lg-12">
								<div class="dash-item">
									<h6 class="item-title"><i class="fa fa-sliders"></i>ALL DOCUMENTS</h6>
                  <div class="top-nav-login-btn pull-left">
      							<a href="addlecturernote"><i class="fa fa-sign-in"></i>ADD NEW DOCUMENT</a>
      						</div>
									<div class="inner-item">
										<table id="attendenceDetailedTable" class=" nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													<th><i class="fa fa-calendar"></i>LECTURER</th>
													<th><i class="fa fa-clock-o"></i>DOCUMENT</th>

													<th><i class="fa fa-clock-o"></i>DESCRIPTION</th>
													<th><i class="fa fa-clock-o"></i>FILE UPLOADED</th>
													<th><i class="fa fa-clock-o"></i>ACTION</th>
												</tr>
											</thead>
											<tbody>
