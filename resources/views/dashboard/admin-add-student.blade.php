    ...
    <body>
		<div class="row dashboard-top-nav">
			<div class="col-sm-3 logo">
				<h5><i class="fa fa-book"></i>STUDENT'S PROFILE</h5>
			</div>
							...
							<div class="col-md-12">
								...
								<div class="dash-item">
									...
									<div class="inner-item">
										<div class="dash-form">
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-id-card"></i>MATRIC NUMBER</label>
												<input type="text" placeholder="PTH2017001" />
											</div>
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-book"></i>PROGRAM</label>
												<select>
													<option>-- Select --</option>
													<option>5 STD</option>
													<option>6 STD</option>
											...
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-cogs"></i>FACULTY</label>
												<select>
													<option>-- Select --</option>
											...
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-puzzle-piece"></i>MODE OF PROGRAM</label>
												<input type="text" placeholder="MIXED MODE" />
                        <input type="text" placeholder="RESEARCH" />
                        <input type="text" placeholder="COURSE WORK" />
											</div>
											<div class="clearfix"></div>
											<div class="col-sm-3">
												<label><i class="fa fa-graduation-cap"></i>QUALIFICATION</label>
												<input type="text" placeholder="UNIVERSITI TEKNOLOGI MALAYSIA" />
											</div>
											<!--<div class="col-sm-3">
											...
											<div class="col-sm-3">
												<label><i class="fa fa-code"></i>CGPA</label>
												<input type="text" placeholder="4.0" />
											</div>
											<div class="col-sm-3">
												<label><i class="fa fa-futbol-o"></i>DEPARTMENT</label>
												<select>
													<option>-- Select --</option>
