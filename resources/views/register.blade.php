...
<div class="col-xs-12" id="programSection">
  ...
  <select class="form-control" name="program">
    ...
    <option>POST-GRAD DIPLOMA IN EDUCATION </option>
    <option>MASTERS IN EDUCATION </option>
    <option>MASTERS IN CURRICULUM AND INSTRUCTIONAL TECHNOLOGY </option>
    <option>PhD IN EDUCATION </option>
    <option>OTHERS</option>
    <input type="text" placeholder="Please enter your program" class="form-control" name="others" id="others"></input>
  </select>
</div>
...
<div class="col-xs-12">
  ...
  <input type="text" placeholder="Identification Number" class="form-control" name="idnum">
        ...
        <div class="col-xs-12">
          ...
          <input type="text" placeholder="Confirm Email" class="form-control" name="confirmemail" id="confemail" onblur="confirmEmail()">
        </div>
        <div class="col-xs-12">
        ...
        <div class="col-xs-12">
          ...
          <input type="text" placeholder="Insert a security question you may need to reset your account" class="form-control" name="question">
        </div>
        <div class="col-xs-12">
          <label>SECURITY ANSWER</label>
          <input type="text" placeholder="Insert security answer" class="form-control" name="answer">
        </div>
        <div class="col-xs-12">
