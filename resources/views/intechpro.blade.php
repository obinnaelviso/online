...
@section('content')
            ...
            <div id="homeSlider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="assets/img/slider/intechpros.jpg" alt="slide1">
                    ...
                    <div class="item">
                        <img src="assets/img/pro3.jpg" alt="slide2">
                        <div class="carousel-caption">
							<h4><i class="fa fa-star-o"></i>WE EMPOWER YOU TO CREATE<i class="fa fa-star-o"></i></h4>
                        <!--    <h2>EDUCATE <span><i class="fa fa-graduation-cap"></i>ILLUMINATE</span> <span> <i class="fa fa-graduation-cap"></i> </span> CREATE</h2>
                            <p>We here at <strong>UNIVERSITI MALAYA</strong> provides best education <br />  </p>
					...
					<div class="item">
                        <img src="assets/img/slider/intechpro.jpg" alt="slide2">
                        <div class="carousel-caption">
							<h4><i class="fa fa-star-o"></i>WE EMPOWER YOU TO CREATE<i class="fa fa-star-o"></i></h4>
                          <!-- <h2>EDUCATE <span><i class="fa fa-graduation-cap"></i>ILLUMINATE</span> <span> <i class="fa fa-graduation-cap"></i> </span> CREATE</h2>
                            <p>We here at <strong>UNIVERSITI MALAYA</strong> provides best education <br />  </p>
			...
			<div class="container">
				<div class="col-sm-4 col-md-3">
					<div class="academic-nav-box">
						...
						<div class="academic-nav-inner-box">
							<a href="#" ><i class="fa fa-video-camera"></i>InTechPro</a>
							<a href="inventor" target="_blank"><i class="fa fa-trophy"></i>Inventor's Hub</a>
				...
				<div class="col-sm-8 col-md-9">
					<div class="academic-content-box">
						<h3>OUR VIDEO CONFERENCE AND TRAINING CENTRE</h3>
						<p>The Instructional Technology Production-based Learning Studio (InTechPro) was initiated to empower students and clients to create digital production content / e-learning materials for teaching and training. The inTechPro allows access to all activities organised for digital production, development of online visual and audio broadcasts,  gallery, and booking of space.</p>
		...
		<div class="container">
				<h2><i class="fa fa-picture-o"></i>INTECHPRO GALLERY</h2>
			</div>
		</div>
<!-- START: GALLERY -->
				...
				<div class="image-set">
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intechpr.jpg" alt="Intechpro">
							<div class="img-caption">
								<div class="link">
									<a title="Fine Arts" href="assets/img/intechpr.jpg">
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/slider/intechpro.jpg" alt="Intechpro">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/slider/intechpro.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intechpro7.jpg" alt="Intechpro">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/intechpro7.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intechpro4.jpg" alt="Intechpro">
							<div class="img-caption">
								<div class="link">
									<a title="Fine Arts" href="assets/img/intechpro4.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intechpro3.jpg" alt="Cruise">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/intechpro3.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-4">
						<div class="image-wrapper">
							<img src="assets/img/intechpro5.jpg" alt="Cruise">
							<div class="img-caption">
								<div class="link">
									<a title="Arts" href="assets/img/intechpro5.jpg">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
...
<div class="section-divider"></div>
<!-- book row -->
<form action="{{ route('intechpro') }}" method="post">
{{ csrf_field() }}
